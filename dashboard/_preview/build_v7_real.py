...
<div class="content">
  <section class="view on" data-view="copy">
    ...
    <section class="sec">
      <div class="sech"><h2>Lệnh copy đã khớp <span class="scaletag" id="copyExecScaleTag">Theo NAV nhập</span></h2><span class="meta">{len(copy_executions)} lệnh · tách riêng lịch sử model</span></div>
