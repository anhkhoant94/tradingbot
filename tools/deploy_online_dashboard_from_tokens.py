...
FILES_TO_PUSH = [
    ...
    "tools/reconcile_dashboard_online_local.py",
    ...
    "output/full_universe_live_update_status.json",
    ...
    "output/beat_vni30_parallel/paper_trade_v4_r46/signal_week_2_20260601.json",
    "output/beat_vni30_parallel/paper_trade_v4_r46/PAPER_TRADE_PROTOCOL_20260530.md",
    "dashboard/data.js",
    "dashboard/full_universe_live_update_status.json",
